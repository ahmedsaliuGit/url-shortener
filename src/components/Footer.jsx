...
function Footer(props) {
  return (
    <footer className="bg-v-dark-violet p-10">
      <div className="lg:container text-center lg:text-left text-white w-11/12 mx-auto lg:flex lg:justify-between">
        <div className="flex justify-center lg:justify-start items-center lg:items-start py-4 lg:py-0 lg:w-2/5">
        ...
        <div className="lg:w-3/5 lg:flex justify-between">
          <div className="text-grayish-violet mt-6 lg:mt-0">
            <h3 className="text-white mb-4 font-bold text-base">Features</h3>
            <p className="mb-2 hover:text-c-cyan hover:cursor-pointer">
              Link Shortening
            </p>
            <p className="mb-2 hover:text-c-cyan hover:cursor-pointer">
              Branded Links
          ...
          <div className="text-grayish-violet mt-6 lg:mt-0">
            ...
            <p className="mb-2 hover:text-c-cyan hover:cursor-pointer">Blog</p>
            <p className="mb-2 hover:text-c-cyan hover:cursor-pointer">
              Developer
            </p>
            <p className="mb-2 hover:text-c-cyan hover:cursor-pointer">
          ...
          <div className="text-grayish-violet mt-6 lg:mt-0">
            ...
            <p className="mb-2 hover:text-c-cyan hover:cursor-pointer">About</p>
            <p className="mb-2 hover:text-c-cyan hover:cursor-pointer">
              Our Team
            </p>
            <p className="mb-2 hover:text-c-cyan hover:cursor-pointer">
          ...
          <div className="flex justify-between items-center lg:items-start w-1/2 lg:w-1/5 mt-10 lg:mt-0 mx-auto lg:mx-10">
            <svg
              className="hover:cursor-pointer hover:fill-current hover:text-cyan-200"
